...
public class KThread {
    ...
    private static void joinTest1() {
        System.out.println("joinTest1 started");

        //a thread cannot be joined by itself

        currentThread.join();

		System.out.println("joinTest1 finished");
    }

    private static void joinTest2() {
        //see if main can join two children
        System.out.println("jointTest2 started");
		KThread thread1 = new KThread(new PingTest(1));
		KThread thread2 = new KThread(new PingTest(2));

		thread1.setName("thread1").fork();
		System.out.println(KThread.currentThread() + " will be sleeping until joined thread finish.");
		thread1.join();
		System.out.println(KThread.currentThread() + " woke up");
        ...
        System.out.println("After joining, thread1 status: (is finished?) " + (thread1.status == statusFinished));
		System.out.println("After joining, thread2 status: (is finished?) " + (thread2.status == statusFinished));
		System.out.println("joinTest2 finished");
		System.out.println();
